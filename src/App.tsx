...
type Tab = 'today' | 'food' | 'training' | 'cardio' | 'body' | 'progress' | 'profile';
  ...
  return (
    <div className="app-shell">
      ...
      <main>
        ...
        {tab === 'body' ? <BodyView date={date} strength={state.strength} onGo={setTab} /> : null}
        {tab === 'progress' ? (
          <ProgressView
            date={date}
            body={state.body}
      ...
      <nav className="tabbar">
        ...
        <TabButton active={tab === 'body'} icon={<PersonStanding />} label="Body" onClick={() => setTab('body')} />
